...
<script>
  ...
  const views = [
    { 
      ...
      info: {
        title: "India",
        content: `Microsoft has just released a global dataset on floods and India stands out as the biggest hotspot over the past 10 years. More than <span style="background-color: red; color: white; padding: 4px;">0.3 million square kilometres (sq km) or 10%</span> of the country’s total land area experienced some form of flooding between 2014 and 2024.`
      }
    },
    { 
      name: 'Punjab+Haryana', 
...
<div class="text-content">
  <div class="container">
    ...
    <h2>About India's Diversity</h2>
    
    <p>India is a land of extraordinary diversity, with 28 states and 8 union territories, each with its own unique culture, language, and traditions. From the snow-capped peaks of the Himalayas in the north to the tropical beaches of the south, India offers a kaleidoscope of experiences.</p>
    
    <p>The country is home to over 1.4 billion people, speaking more than 700 languages, with 22 official languages recognized by the constitution. This linguistic diversity reflects the rich cultural tapestry that makes India truly unique among nations.</p>
    
    <h2>Economic Powerhouse</h2>
    
    <p>Today, India stands as one of the world's fastest-growing major economies. The states you explored in the scrollytelling section above each contribute significantly to this growth. Punjab and Haryana remain the agricultural backbone, while states like Uttar Pradesh contribute through both agriculture and manufacturing.</p>
  </div>
</div>